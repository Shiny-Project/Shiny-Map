...
module.exports = {
    ...
    highlight: async (needHighlight, center) => {
        ...
        try {
            ...
            setFooter(`Generated by Shiny-Map @ ${new Date().toISOString()} / ©2021 Shiny Project`);
        } catch (e) {
    ...
    shindoEarlyReport: async (shindo) => {
        ...
        try {
            await page.evaluate((shindoGeoJson) => {
                ...
                setFooter(`Generated by Shiny-Map @ ${new Date().toISOString()} / ©2021 Shiny Project / Data Source: 気象庁`);
                setTitle(`震度速报`);
            }, shindoGeoJson)
        } catch (e) {
            Sentry.captureException(e);
