...
const { copyrightText } = require("../constants");
...
module.exports = {
    ...
    highlight: async (needHighlight, center) => {
        ...
        try {
            await page.evaluate(
                (needHighlight, provinceData, center, copyrightText) => {
                    ...
                    setFooter(`Generated by Shiny-Map @ ${new Date().toISOString()} / ${copyrightText}`);
                },
                needHighlight,
                provinceData,
                center,
    ...
    shindoEarlyReport: async (shindo) => {
        ...
        try {
            await page.evaluate((shindoGeoJson, copyrightText) => {
                ...
                setFooter(
                    `Generated by Shiny-Map @ ${new Date().toISOString()} / ${copyrightText} / Data Source: 気象庁`
                );
                setTitle(`震度速报`);
            }, shindoGeoJson, copyrightText);
    ...
    tsunamiWarning: async (tsunamiAreas) => {
        ...
        try {
            await page.evaluate(
                (areaLevelMap, areaData, copyrightText) => {
                    showTsunamiLegend();
                    map.addLayer(JapanSimpleMapLayer);
    ...
    tsunamiWarningCancel: async () => {
        ...
        try {
            await page.evaluate((copyrightText) => {
                showTsunamiLegend();
    ...
    typhoonInfo: async (typhoonData) => {
        ...
        await lock.acquire();
        try {
            await page.evaluate((data, copyrightText) => {
