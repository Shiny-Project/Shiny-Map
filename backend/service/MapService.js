...
module.exports = {
    ...
    highlight: async (needHighlight, center) => {
        ...
        try {
            ...
            setFooter(`Generated by Shiny-Map @ ${new Date().toISOString()} / ©2018 Shiny Project`);
        } catch (e) {
    ...
    shindoEarlyReport: async (shindo) => {
        ...
        try {
            await page.evaluate((shindoGeoJson) => {
                ...
                setFooter(`Generated by Shiny-Map @ ${new Date().toISOString()} / ©2018 Shiny Project / Data Source: 気象庁`);
                setTitle(`震度速报`);
            }, shindoGeoJson)
        } catch (e) {
            console.log('Navigation failed: ' + e.message);
    ...
    tsunamiWarning: async (tsunamiAreas) => {
        const page = global.page;
        const areaData = JSON.parse(fs.readFileSync(path.resolve(__dirname, '../definition/jma_tsunami_area.json')).toString());
        const areaLevelMap = {};
        ...
        global.isBrowserBusy = true;
        try {
            await page.evaluate((areaLevelMap, areaData) => {
                map.addLayer(JapanSimpleMapLayer);
                ...
                map.getView().fit(getLayerByName('tsunami_warning').getSource().getExtent(), {
                    maxZoom: 7
                });
                setFooter(`Generated by Shiny-Map @ ${new Date().toISOString()} / ©2018 Shiny Project / Data Source: 気象庁`);
                setTitle(`海啸警报`);
